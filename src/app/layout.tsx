      ...
      <body className="bg-[#05070f] text-white min-h-screen">
        <nav className="border-b border-white/10 bg-black/40 backdrop-blur-xl sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            <a href="/" className="text-xl font-bold text-emerald-400">AlphaPulse</a>
            <div className="flex items-center gap-6 text-sm">
              ...
              <a href="/premium" className="rounded-lg bg-emerald-500 px-3 py-1.5 text-black font-semibold hover:bg-emerald-400">Premium</a>
            </div>
          </div>
        </nav>
        <main>{children}</main>
